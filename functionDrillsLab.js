...
let nameGreeting = nameCheck('goldilocks')
...
console.log(emailCheck(' example1@gmail.com '))
////////////////// PROBLEM 19 ////////////////////
/*
  Write a function, naming it whatever you believe to be appropriate, that buys as 
  many chocolate frogs as possible with a certain amount of gold. Each chocolate frog 
  costs 3 gold. Your function should take in a single parameter, which is the amount of 
  gold you are willing to spend. Your function should return a total amount of chocolate 
  frogs you were able to purchase.
  Create a variable called `totalFrogs` and set it equal to your function invoked, passing 
...
function chocolateFroggies(budget) {
  let frogsPurchased = budget / frogCost
  return frogsPurchased
}

totalFrogs = chocolateFroggies(budget)
...
//CODE HERE
function chocolateFroggies2(budget) {
  let frogsPurchased = budget / frogCost
  return parseInt(frogsPurchased)
}

totalFrogs2 = chocolateFroggies2(budget)
